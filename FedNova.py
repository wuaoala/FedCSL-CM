...
if __name__ == '__main__':
    ...
    # print('FedNova算法 Average Global AUC-PR: {:.4f}'.format(sum(fedavg_test_AUC_PR) / args.epochs))
    # print('FedNova算法 Average Global KS: {:.4f}'.format(sum(fedavg_test_KS) / args.epochs))
    # print('FedNova算法 Average Global BS+: {:.4f}'.format(sum(fedavg_test_BS_plus) / args.epochs))
    ...
    # list2txt(result, "./save/{} FedNova results.txt".format(args.dataset))
