...
if __name__ == '__main__':
    ...
    gamma = 0
    alpha = 0.8
    lamda_list = [0.1,0.3,0.5,0.7,0.9]
    ...
    for lamda in lamda_list:
        ...
        print('The average performance over 50 runs corresponds to the results reported in Table 12')
        print('FedCSL-CM parameter λ={}'.format(lamda))
